...
public class DataSetTester{
   public static void main(String[] args)
   {
      ...
      System.out.println("Average batting average: " + String.format("%.3f", battingAvgData.getAverage()));
      System.out.println("Expected: .329");
      BaseballPlayer maxA = battingAvgData.getMaximum();
      System.out.println("Highest batting average: " + String.format("%.3f",maxA.getBattingAverage()) + " "+ maxA.getName() + " of the " + maxA.getTeam());
